...
2. *File → Open* e escolha a pasta `Contexto/android`.
...
└── app/src/main/java/com/contexto/app/
    ├── ContextoApp.kt         Application + AppContainer (injeção de dependências manual)
    ...
    └── ui/
        ...
        └── ContextoRoot.kt    navegação, barra inferior, folhas (+, item, antes de sair)
```
