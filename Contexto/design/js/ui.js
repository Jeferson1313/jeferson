/* =========================================================
   Contexto — componentes reutilizáveis
...
(function () {
  ...
  /* ---------- Notificações ---------- */
  function notif(o) {
    let h = '<div class="nt-card' + (o.cls ? ' ' + o.cls : '') + '"><div class="nt-hd"><span class="app-i">' + logo(14, '#fff', '#fff') + '</span>Contexto' + (o.sub ? ' · ' + o.sub : '') + '<span class="tm">' + (o.time || 'agora') + '</span></div>' +
