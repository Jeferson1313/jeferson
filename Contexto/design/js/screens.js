/* =========================================================
   Contexto — definição de todas as telas
...
(function () {
  ...
  add({ id: 'T01', group: 'Abertura', name: 'Splash',
    ...
    html: phone({ invStatus: true, raw: '<div class="splash">' + logo(84, '#fff', '#fff') + '<div class="wm">contexto</div><div class="tl">Lembre no lugar certo.</div><div class="ver">v1.0</div></div>' }) });
  ...
  add({ id: 'T03', group: 'Abertura', name: 'Onboarding 2 · Gatilho',
    ...
    html: phone({ raw: onboarding(2, obArt2, 'Chegou no lugar certo? A gente lembra você.', 'Ao chegar ou sair de um lugar, o Contexto mostra só o que importa ali. O resto espera.', 'Continuar') }) });
  ...
  add({ id: 'T37', group: 'Erros e permissões', name: 'Permissões',
    ...
    html: phone({ body: top({ left: ib('chevL'), title: 'Permissões' }) +
      '<div class="h2">O que o Contexto consegue perceber</div><div class="sub">Cada permissão libera um tipo de lembrete. Nada sai do seu aparelho.</div>' +
  ...
  add({ id: 'T38', group: 'Erros e permissões', name: 'Gatilho indisponível',
    ...
    html: phone({ body: top({ left: ib('x'), title: 'Novo gatilho', right: '<span class="dist">1 de 2</span>' }) +
      ...
      '<div style="margin-top:16px">' + banner('warn', 'bt', 'Bluetooth desligado', 'Ligue para o Contexto perceber quando você entra no carro.', ['Ligar Bluetooth']) + '</div>' +
