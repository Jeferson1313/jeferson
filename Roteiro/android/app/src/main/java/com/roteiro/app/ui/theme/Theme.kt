package com.roteiro.app.ui.theme
...
object C {
    val colors: RoteiroColors
        @Composable @ReadOnlyComposable get() = LocalColors.current
}

@Composable
fun RoteiroTheme(dark: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
